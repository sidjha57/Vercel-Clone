...
const BACKEND_UPLOAD_URL = import.meta.env.BACKEND_UPLOAD_URL || "http://localhost:4500";
const BACKEND_REQUEST_PORT = import.meta.env.BACKEND_REQUEST_PORT || 4300;
      ...
      {deployed && <Card className="w-full max-w-md mt-8">
        ...
        <CardContent>
          <div className="space-y-2">
            ...
            <Input id="deployed-url" readOnly type="url" value={`http://${uploadId}.my-vercel.com:${BACKEND_REQUEST_PORT}/index.html`} />
          </div>
          <br />
          <Button className="w-full" variant="outline">
            <a href={`http://${uploadId}.my-vercel.com:${BACKEND_REQUEST_PORT}/index.html`} target="_blank">
              Visit Website
            </a>
          </Button>
        </CardContent>
        ...
        <Button onClick={ () => {
          ...
          setUploading(false);
          setDeployed(false);
        }} disabled={!deployed} className="mt-10" type="submit">
          Reset
        </Button>
